...
/**
 * An implementation of Ryu for {@code double}, ported from the Apache-2.0
 ...
 * original {@code double}, using the {@code Double.toString} formatting rules
 ...
 * <p>
 * {@code result} must have room for at most 24 bytes at {@code index} (e.g.
...
public final class RyuDouble {
     ...
     * {@link Double#toString(double)} semantics. Returns the number of bytes
     * written.
     */
    public static int writeDouble(double value, byte[] result, int index) {
