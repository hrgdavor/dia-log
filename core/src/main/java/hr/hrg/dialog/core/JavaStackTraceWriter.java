...
public static long fingerprint(Throwable rootCause, Predicate<String> filter) {
     ...
     */
    public static void addFromTrace(StackTraceElement[] trace,
     ...
     */
    public static void addFromTraceToStringBuffer(StackTraceElement[] trace,
            StringBuffer sb) {
     ...
     */
    public static void addFromTraceToOutputStream(StackTraceElement[] trace,
     ...
     * @throws IOException if writing fails
     */
    public static void addFromTraceToOutputStreamJson(StackTraceElement[] trace,
            OutputStream out) throws IOException {
     ...
     * @throws IOException if writing fails
     */
    public static long addFromTraceToOutputStreamJsonAndFingerprint(StackTraceElement[] trace,
            OutputStream out,
     ...
     * @throws IOException if writing fails
     */
    public static void addFromTraceToOutputStreamWithNewline(StackTraceElement[] trace,
            OutputStream out,
     ...
     */
    public static long addFromTraceToOutputStreamWithNewlineAndFingerprint(StackTraceElement[] trace,
            OutputStream out,
            byte[] newlineBytes,
            String throwableClassName,
            Wyhash64.Streaming stream) throws IOException {
