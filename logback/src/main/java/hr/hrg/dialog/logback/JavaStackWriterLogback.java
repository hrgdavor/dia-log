...
public static long fingerprint(IThrowableProxy rootCause, Predicate<String> filter) {
     ...
     */
    public static void addFromTrace(StackTraceElementProxy[] trace,
     ...
     */
    public static void addFromTraceToStringBuffer(StackTraceElementProxy[] trace,
            StringBuffer sb) {
     ...
     */
    public static void addFromTraceToOutputStream(StackTraceElementProxy[] trace,
     ...
     * @throws IOException if writing fails
     */
    public static void addFromTraceToOutputStreamJson(StackTraceElementProxy[] trace,
            OutputStream out) throws IOException {
    ...
    public static long addFromTraceToOutputStreamJsonAndFingerprint(StackTraceElementProxy[] trace,
        ...
        public static long addFromTraceToOutputStreamJsonAndFingerprint(StackTraceElementProxy[] trace,
            ...
            return addFromTraceToOutputStreamWithNewlineAndFingerprint(trace, out, NEWLINE_JSON_BYTES, throwableClassName, stream);
    }
     ...
     * @throws IOException if writing fails
     */
    public static void addFromTraceToOutputStreamWithNewline(StackTraceElementProxy[] trace,
            OutputStream out,
        ...
        // if (isFirstFrame) {
            ...
            // for (int i = 0; i < limit; i++) {
                // out.write(newlineBytes);
                // StackTraceElement el = trace[i].getStackTraceElement();
                // JavaStackTraceWriter.stringWriteStrategy.write(out,el.getClassName());
                // out.write(DOT_BYTES);
                // JavaStackTraceWriter.stringWriteStrategy.write(out,el.getMethodName());
            // }
        // }
    }
    ...
    public static long addFromTraceToOutputStreamWithNewlineAndFingerprint(StackTraceElementProxy[] trace,
        ...
        // if (isFirstFrame) {
            ...
            // for (int i = 0; i < limit; i++) {
                ...
                // String className = el.getClassName();
                // String methodName = el.getMethodName();
                // JavaStackTraceWriter.stringWriteStrategy.write(out,className);
                // out.write(DOT_BYTES);
                // JavaStackTraceWriter.stringWriteStrategy.write(out,methodName);
