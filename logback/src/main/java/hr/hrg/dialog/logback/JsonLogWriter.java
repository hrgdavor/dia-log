...
public class JsonLogWriter {
    ...
    // rewrites the block into the UTF-8 bytes for the stream fallback, the 1-2
    // packed little-endian long words for the direct-buffer path (one 8-byte
    ...
    private static void writeFieldPrefix(OutputStream out, byte[] key) throws IOException {
        out.write(',');
        out.write(key);
    }
